...
if not taskRequest:
    masterConn.close()
parsedJSON_msg = json.loads(taskRequest.decode()) #Convert to Python dictionary
task_completition_msg = Worker.listenForTask(parsedJSON_msg) #Call the method defined in Worker class in WorkerSimulation
